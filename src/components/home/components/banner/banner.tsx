        ...
        <div className="height-work">
          <div className="grid grid-cols-1 lg:grid-cols-12 my-16">
            ...
            <div className="col-span-7">
              ...
              <p className="md:text-lg font-normal mb-10 md:text-start text-center">
                Lorem Ipsum is simply dummy text of the printing and <br /> typesetting industry. Lorem Ipsum has been
                the industry <br /> standard dummy text ever since the 1500s
              </p>
              <div className="flex align-middle justify-center md:justify-start">
                <button className="text-xl font-semibold py-4 px-6 lg:px-12 navbutton mr-6 text-white">
                  Get Started
                </button>
