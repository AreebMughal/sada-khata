          ...
          <div className="relative flex h-12 sm:h-20 items-center">
            <div className="flex flex-1 items-center sm:justify-between">
              ...
              <div className="flex flex-shrink-0 items-center">
                <img className="block h-10 w-20px lg:hidden" src={'/images/Logo/logo.svg'} alt="Crypto-Logo" />
                <img className="hidden h-48px w-48px lg:block" src={'/images/Logo/logo.svg'} alt="Crypto-Logo" />
              </div>
                  ...
                  {navigation.map(item => (
                    <Link
                      ...
                      className={classNames(
                        item.current ? 'bg-gray-900' : 'navlinks text-white hover-underline',
