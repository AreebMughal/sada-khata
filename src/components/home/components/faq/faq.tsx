...
const Faq = () => {
  return (
    <div className="my-20 px-6" id="faq-section">
      ...
      <p className="text-center lg:text-lg font-normal text-[#0C1A48]">
        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has <br /> been the
                  ...
                  <Disclosure>
                    {({ open }) => (
                      <>
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 md:text-lg text-white font-normal opacity-50">
                          {items.subheading}
                        </Disclosure.Panel>
                      </>
                    )}
