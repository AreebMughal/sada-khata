    ...
    return (
        <div className="simple-bg relative">
            ...
            <div className="mx-auto max-w-5xl py-24 px-6">
                <h3 className="text-center text-3xl lg:text-5xl font-semibold mb-6">A simple, secure way to buy <br /> and sell cryptocurrency</h3>
                <p className="text-center text-lg font-normal mb-8">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum <br /> has been the industry</p>
