...
export const Createtable = () => {
  ...
  const [tableData, setTableData] = useState([
    { id: '12809', product: 'Apple Macbook Pro...', time: '20/03/2023,01:10', status: 'Waiting Payment', qty: 'x1', price: '$4.012', customer: 'Omar Griffith' },
    // Initial table data...
  ]);
  const [formData, setFormData] = useState({
    id: '', product: '', time: '', status: '', qty: '', price: '', customer: ''
  });
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (e) => {
    ...
    setShowPopup(false);
    setFormData({ id: '', product: '', time: '', status: '', qty: '', price: '', customer: '' });
  };
