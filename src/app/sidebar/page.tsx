  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      >
        ...
        <div
          className={`p-4 transition-opacity duration-300 ease-in-out ${isOpen ? 'opacity-100' : 'opacity-0'
            }`}
        >
      ...
      {/* Main Content */}
      <div
        className={`flex-1 transition-all duration-300 ease-in-out transform ${isOpen ? 'ml-64' : 'ml-0'
          }`}
      >
        {/* Hamburger Icon */}
        <button
